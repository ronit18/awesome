...
globalkeys = my_table.join(
    ...
    awful.key({ altkey, ctrlkey }, "f", function () awful.spawn( 'firefox' ) end,
              {description = "firefox", group = "awesome"}),
    awful.key({ altkey, ctrlkey }, "s", function () awful.spawn( 'spotify' ) end,
              {description = "spotify", group = "awesome"}),
    ...
    -- Run launcher
    awful.key({ altkey }, "Return", function () awful.util.spawn("dm-run") end,
...
awful.spawn.with_shell("ap-applet")
